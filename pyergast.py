...
def get_schedule(year=None):
  ...
  #  assert r.status_code == 200, 'Cannot connect to Ergast API. Check your inputs.'
    schedule = json.load(r)['MRData']['RaceTable']['Races']
...
def driver_standings(year=None, race=None):
   ...
   # assert r.status_code == 200, 'Cannot connect to Ergast API. Check your inputs.'
    driverStandings = json.load(r)['MRData']['StandingsTable']['StandingsLists'][0]['DriverStandings']
...
def constructor_standings(year=None, race=None):
   ...
   # assert r.status_code == 200, 'Cannot connect to Ergast API. Check your inputs.'
    constructorStandings = json.load(r)['MRData']['StandingsTable']['StandingsLists'][0]['ConstructorStandings']
...
def query_driver(driverid):
    ...
    try:
        ...
        print('Error 200')
  #  assert r.status_code == 200, 'Cannot connect to Ergast API. Check your inputs.'
    seasons = json.load(r)['MRData']['StandingsTable']['StandingsLists']
